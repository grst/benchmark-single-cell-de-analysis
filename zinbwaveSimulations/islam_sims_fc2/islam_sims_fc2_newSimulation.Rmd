...
```{r}
tmp_res_wald = diffxpy_wald(counts=simDataIslam$counts, group=grp)
res[["diffxpy_wald"]] = tmp_res_wald
...
save(res, file="../../results/resIslamFc2.rda")
```
