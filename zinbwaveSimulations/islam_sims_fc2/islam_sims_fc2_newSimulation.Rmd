...
```{r}
res[["diffxpy_wald"]] = diffxpy_wald(counts=simDataIslam$counts, group=grp)
# res[["diffxpy_lrt"]] = diffxpy_lrt(counts=simDataIslam$counts, group=grp)
```

```{r}
res[["statsmodels_nb"]] = statsmodels_nb(counts=simDataIslam$counts, group=grp)
res[["statsmodels_zip"]] = statsmodels_zip(counts=simDataIslam$counts, group=grp)
res[["statsmodels_zinb"]] = statsmodels_zinb(counts=simDataIslam$counts, group=grp)
```

```{r}
# res[["scqtl"]] = scqtl_wald(counts=simDataIslam$counts, group=grp)
...
save(res, file="../../results/resIslamFc2.tmp.rda")
```
